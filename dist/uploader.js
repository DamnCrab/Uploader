...
(function (global, factory) {
  ...
  var utils$3 = {
    ...
    nextTick: function nextTick(fn, context) {
      setTimeout(utils$3.bind(fn, context), 0);
    },
    ...
    each: function each(ary, func, context) {
      if (utils$3.isDefined(ary.length)) {
    ...
    evalOpts: function evalOpts(data, args) {
      if (utils$3.isFunction(data)) {
        // `arguments` is an object, not array, in FF, so:
        args = utils$3.toArray(arguments);
        ...
        if ((options = arguments[i]) != null) {
          for (name in options) {
            ...
            if (force && copy && (isPlainObject(copy) || (copyIsArray = isArray(copy)))) {
              ...
              target[name] = utils$3.extend(force, clone, copy);
  ...
  var utils$2 = utils_1;
  function Chunk$2(uploader, file, offset) {
    utils$2.defineNonEnumerable(this, 'uploader', uploader);
    utils$2.defineNonEnumerable(this, 'file', file);
    utils$2.defineNonEnumerable(this, 'bytes', null);
    this.offset = offset;
    this.tested = false;
    this.retries = 0;
    ...
    this.loaded = 0;
    this.total = 0;
    this.chunkSize = utils$2.evalOpts(uploader.opts.chunkSize, file, this);
    this.startByte = this.offset * this.chunkSize;
    this.endByte = this.computeEndByte();
    this.xhr = null;
  }
  var STATUS = Chunk$2.STATUS = {
    PENDING: 'pending',
    UPLOADING: 'uploading',
    READING: 'reading',
    SUCCESS: 'success',
  ...
  utils$2.extend(Chunk$2.prototype, {
    _event: function _event(evt, args) {
      args = utils$2.toArray(arguments);
      args.unshift(this);
    ...
    test: function test() {
      ...
      var testMethod = utils$2.evalOpts(this.uploader.opts.testMethod, this.file, this);
    ...
    send: function send() {
      ...
      if (utils$2.isFunction(preprocess)) {
      ...
      var uploadMethod = utils$2.evalOpts(this.uploader.opts.uploadMethod, this.file, this);
    ...
    prepareXhrRequest: function prepareXhrRequest(method, isTest, paramsMethod, blob) {
      ...
      var query = utils$2.evalOpts(this.uploader.opts.query, this.file, this, isTest);
      query = utils$2.extend(this.getParams(), query);

      // processParams
      query = this.uploader.opts.processParams(query, this.file, this, isTest);
      var target = utils$2.evalOpts(this.uploader.opts.target, this.file, this, isTest);
      var data = null;
      if (method === 'GET' || paramsMethod === 'octet') {
        // Add data from the query options
        var params = [];
        utils$2.each(query, function (v, k) {
      ...
      utils$2.each(utils$2.evalOpts(this.uploader.opts.headers, this.file, this, isTest), function (v, k) {
  ...
  var utils$1 = utils_1;
  var Chunk$1 = chunk;
  function File$1(uploader, file, parent) {
    utils$1.defineNonEnumerable(this, 'uploader', uploader);
    this.isRoot = this.isFolder = uploader === this;
    utils$1.defineNonEnumerable(this, 'parent', parent || null);
    utils$1.defineNonEnumerable(this, 'files', []);
    utils$1.defineNonEnumerable(this, 'fileList', []);
    utils$1.defineNonEnumerable(this, 'chunks', []);
    utils$1.defineNonEnumerable(this, '_errorFiles', []);
    utils$1.defineNonEnumerable(this, 'file', null);
    this.id = utils$1.uid();
    if (this.isRoot || !file) {
      this.file = null;
    } else {
      if (utils$1.isString(file)) {
        // folder
        this.isFolder = true;
        this.file = null;
        this.path = file;
  ...
  utils$1.extend(File$1.prototype, {
    ...
    _eachAccess: function _eachAccess(eachFn, fileFn) {
      if (this.isFolder) {
        utils$1.each(this.files, function (f, i) {
    ...
    bootstrap: function bootstrap() {
      ...
      if (utils$1.isFunction(opts.initFileFn)) {
      ...
      for (var offset = 0; offset < chunks; offset++) {
        this.chunks.push(new Chunk$1(this.uploader, this, offset));
      }
    },
    _measureSpeed: function _measureSpeed() {
    ...
    _updateUploadedChunks: function _updateUploadedChunks(message, chunk) {
      ...
      if (checkChunkUploaded) {
        var xhr = chunk.xhr;
        utils$1.each(this.chunks, function (_chunk) {
          if (!_chunk.tested) {
      ...
      if (!this.completed) {
        ...
        this._eachAccess(function (file) {
          ...
          if (this.error) {
            ...
            var STATUS = Chunk$1.STATUS;
            utils$1.each(this.chunks, function (chunk) {
    ...
    isUploading: function isUploading() {
      ...
      this._eachAccess(function (file) {
        ...
        var uploadingStatus = Chunk$1.STATUS.UPLOADING;
        utils$1.each(this.chunks, function (chunk) {
    ...
    abort: function abort(reset) {
      ...
      var uploadingStatus = Chunk$1.STATUS.UPLOADING;
      utils$1.each(chunks, function (c) {
    ...
    progress: function progress() {
      ...
      this._eachAccess(function (file, index) {
        ...
        var bytesLoaded = 0;
        utils$1.each(this.chunks, function (c) {
    ...
    getFormatSize: function getFormatSize() {
      ...
      return utils$1.formatSize(size);
    },
    ...
    _delFilePath: function _delFilePath(file) {
      ...
      utils$1.each(file.fileList, function (file) {
    ...
    _removeFile: function _removeFile(file) {
      ...
      file.parent === this && utils$1.each(this.fileList, function (f, i) {
        if (f === file) {
